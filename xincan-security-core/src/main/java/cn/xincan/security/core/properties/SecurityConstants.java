...
public interface SecurityConstants {
	 ...
	 * 默认的处理错误信息页
	 */
	String DEFAULT_VALIDATE_ERROR_URL = "/error";

	/**
	 * 当请求需要身份认证时，默认跳转的url 参见BrowserSecurityController
	 *
	 */
	...
	/**
	 * 默认登录页面 参见BrowserSecurityController
	 */
	String DEFAULT_SIGN_IN_PAGE_URL = "/browser-login.html";
	/**
